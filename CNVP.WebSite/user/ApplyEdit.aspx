                ...
                <div class="cnvp-tab-panle">
                            ...
                            <asp:Repeater ID="rptBulk" runat="server">
                                <ItemTemplate>
                                    <tr class="bulkfright">
                                        ...
                                        <td><input type="text" name="Class" class="easyui-validatebox" required="true" value="<%#Eval("Class")%>" /></td>
                                        <td><input type="text" name="DangerousNo" class="easyui-validatebox" required="true" value="<%#Eval("DangerousNo")%>" /></td>
                                        ...
                                        <td><input type="text" name="Remark" class="easyui-validatebox" required="true" value="<%#Eval("Remark")%>" tipPosition="left" /></td>
                                      </tr>
                                </ItemTemplate>
                            </asp:Repeater>
                        </table>
                    ...
                    <div class="table-1">
                        ...
                        <div class="control-group">
                            ...
                            <div class="clear1"><img src="<%=mfile0_0 %>" width="160" height="120"  /><a href="<%=mfile0_0 %>" target="_blank">查看大图</a></div>
                        </div>
                        <div class="control-group">
                            <label for="in-out" class="control-label1">2、<span>船舶证书</span> | <a href="javascript:;" class="del-img">删除</a>
                            </label>
                            <div class="controls controls-inline">
                            ...
                            <div class="clear1"><img src="<%=mfile0_1 %>" width="160" height="120"  /><a href="<%=mfile0_1 %>" target="_blank">查看大图</a></div>
                        </div>
                        <div class="control-group">
                            <label for="in-out" class="control-label1">3、<span>配载图</span> | <a href="javascript:;" class="del-img">删除</a></label>
                            <div class="controls controls-inline">
