<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reg.aspx.cs" Inherits="CNVP.WebSite.reg" %>
...
<body>
    <div class="wrap-reg">
    	<div class="reg">
    		<form action="?Action=reg" method="post" id="ff" class="form-horizontal" runat="server">
	    		<fieldset>
