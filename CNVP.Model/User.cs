...
namespace CNVP.Model
{
    ...
    public class User : DbUtils<User>
    {
        ...
        private string _UserCertificateNo = null;
        /// <summary>  
        /// UserCertificateNo  
        /// </summary>  
        /// <returns></returns>  
        [Description("UserCertificateNo")]
        public string UserCertificateNo
        {
            get
            {
                return this._UserCertificateNo;
            }
            set
            {
                this._UserCertificateNo = value;
            }
        }
    }  
}
